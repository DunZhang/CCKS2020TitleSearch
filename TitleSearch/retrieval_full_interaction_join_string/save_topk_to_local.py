...
if __name__ == "__main__":
    ...
    sens_path = r"G:\Codes\PythonProj\CCKS2020TitleSearch\data\format_data\test_data.txt"
    save_path = r"G:\Codes\PythonProj\CCKS2020TitleSearch\data\format_data\test_topk_ent_ids.bin"
    ...
    with open(sens_path, "r", encoding="utf8") as fr:
        for idx, line in enumerate(fr):
            ...
            topk_ent_ids = topk_searcher.get_topk_ent_ids(title)
