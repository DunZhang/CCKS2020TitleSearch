...
import argparse
from TripleTrain import triple_train

parser = argparse.ArgumentParser()
parser.add_argument("--batch_size", default=32, type=int)
parser.add_argument("--num_epochs", default=5, type=int)
parser.add_argument("--attr2max_len", default=str({"name": 60}), type=str)
...
parser.add_argument("--num_neg_examples_per_record", default=30, type=int)
...
parser.add_argument("--entid2gid_path",
                    ...
                    type=str)
# 保存模型位置
parser.add_argument("--out_dir", default="rbt_only_name_V1", type=str)
